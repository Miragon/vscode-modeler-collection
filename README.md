...
**Model-based design in VS Code. BPMN, Team Topologies, Wardley Maps, Context Maps, Event Storming and Domain Storytelling in a single install.**
...
so you can move between process, organization, strategy, architecture, discovery and domain diagrams without leaving your editor.
...
| **Event Storming Modeler** | Explore a domain as a timeline of domain events, commands and aggregates. | [Install](https://marketplace.visualstudio.com/items?itemName=miragon-gmbh.event-storming-modeler) | [Install](https://open-vsx.org/extension/miragon-gmbh/event-storming-modeler) | [Repo](https://github.com/Miragon/event-storming-modeler) |
...
- **Discovery**. How the domain unfolds as events over time (Event Storming).
